...
class AboutControlStatements < Neo::Koan
  ...
  def test_break_statement_returns_values
    ...
    assert_equal 2, result #retornando o valor de i qnd a condicao i%2 == 0 é satisfeita
  end
  ...
  def test_next_statement
    ...
    while i < 10
      i += 1
      next if (i % 2) == 0 #se i for par entao para tudo no loop agora e vai pro proximo
      result << i
    end
